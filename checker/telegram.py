...
class TelegramNotifier:
    ...
    def send_hit(self, hit_num: int, username: str, checked: int) -> bool:
        ...
        msg = (
            ...
            f"  🔗 <b>Link:</b> <a href=\"https://instagram.com/{username}\">instagram.com/{username}</a>\n"
            f"\n"
            f"━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
        ...
        buttons = [
            [
                {"text": "📸 Open Instagram", "url": f"https://instagram.com/{username}"},
    ...
    def send_start(self) -> bool:
        ...
        msg = (
            f"🤖 <b>InstaUserCheckBot Started</b>\n"
            f"━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            f"\n"
