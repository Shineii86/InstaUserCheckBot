...
from .instagram import InstagramClient, AVAILABLE, TAKEN, RATE_LIMITED, ERROR
...
class Checker:
    ...
    def __init__(self, config: Config):
        ...
        self.client = InstagramClient(
            config.user_agents, self.proxy_mgr,
        ...
        self.generator = UsernameGenerator(
            ...
            avoid_start_dot=config.avoid_start_dot,
            avoid_end_dot=config.avoid_end_dot,
    ...
    def _check_one(self, username: str) -> str:
        ...
        if self.config.auto_adjust_delay and self.client.consecutive_rate_limits >= 3:
    ...
    def _print_banner(self):
        print(f"\n{CYN}{'═' * 50}{RST}")
        print(f"{BOLD}{CYN}  📸 InstaUserCheckBot v3.0{RST}")
        print(f"{CYN}{'═' * 50}{RST}")
